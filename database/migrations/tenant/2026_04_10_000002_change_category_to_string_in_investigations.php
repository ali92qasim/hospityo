...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            // SQLite doesn't support MODIFY — columns are already flexible in SQLite
            // No action needed as SQLite doesn't enforce ENUM types
            return;
        }

        // Change ENUM to VARCHAR for category and sample_type (MySQL/MariaDB)

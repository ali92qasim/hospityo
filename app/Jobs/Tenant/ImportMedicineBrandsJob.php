...
class ImportMedicineBrandsJob implements ShouldQueue
{
    ...
    public function handle(MedicineBrandImportService $service): void
    {
    ...
    {
        Log::error('[MedicineBrandImport] Job failed', [
            'user_id' => $this->userId,

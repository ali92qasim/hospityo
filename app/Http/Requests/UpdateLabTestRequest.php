...
class UpdateLabTestRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'category' => 'required|in:hematology,biochemistry,microbiology,immunology,pathology,molecular,radiology',
            'sample_type' => 'required|in:blood,urine,stool,sputum,csf,tissue,swab,other,none',

...
uses()
    ...
    ->in('Feature/Accounting', 'Feature/HR', 'Feature/Billing', 'Feature/Lab', 'Feature/Imaging', 'Feature/Pharmacy', 'Feature/Visits', 'Feature/Navigation', 'Feature/Module', 'Unit/Services');

    ...
    <form action="{{ route('investigation-orders.store') }}" method="POST" id="order-form">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="special_instructions" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue" placeholder="Special handling or collection instructions...">{{ old('special_instructions') }}</textarea>
            </div>
        </div>
                    ...
                    <tbody id="items-body">
                        ...
                        <tr class="item-row border-t border-gray-100">
                            ...
                            <td class="px-4 py-2 text-center">
                                <button type="button" onclick="removeRow(this)" class="text-red-400 hover:text-red-600 transition-colors remove-btn" title="Remove" style="{{ count($oldItems) <= 1 ? 'display:none' : '' }}">
...
function removeRow(btn) {
    ...
    syncRemoveButtons();
    // Re-validate remaining rows after removal
...
// Block form submission if duplicates exist
...
// Attach change listener to existing rows

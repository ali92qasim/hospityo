...
<div class="max-w-3xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Medicine Category</h1>
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        <form action="{{ route('medicine-categories.update', $medicineCategory) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input 
                        ...
                        name="code" 
                        id="code" 
                        value="{{ old('code', $medicineCategory->code) }}"
            ...
            <div class="mb-6">
                ...
                >{{ old('description', $medicineCategory->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input 
                        ...
                        name="is_active" 
                        value="1"
                        {{ old('is_active', $medicineCategory->is_active) ? 'checked' : '' }}

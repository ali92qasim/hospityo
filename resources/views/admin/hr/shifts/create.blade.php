    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-800">Shift Information</h3>
        ...
        <form action="{{ route('hr.shifts.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="time" name="start_time" value="{{ old('start_time') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent js-time-picker" required>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="break_duration" value="{{ old('break_duration', 0) }}" min="0"
                    ...
                    <div>
                        ...
                        <input type="number" name="working_hours" value="{{ old('working_hours') }}" min="0" step="0.5"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="grace_minutes" value="{{ old('grace_minutes', 15) }}" min="0"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent">

...
@section('page-title', 'Add Salary Component')
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800 flex items-center">
                <i class="fas fa-plus-circle mr-2 text-medical-blue"></i>Add Salary Component
            </h3>
        </div>
        <div class="p-6">
            <form action="{{ route('hr.payroll.store-component') }}" method="POST">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" placeholder="e.g. House Rent Allowance"
                    ...
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code') }}" placeholder="e.g. HRA"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" required>
                    ...
                    <div>
                        ...
                        <select name="calculation" id="calculation" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" required>
                            ...
                            <option value="percentage" {{ old('calculation') == 'percentage' ? 'selected' : '' }}>Percentage</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="number" name="default_amount" value="{{ old('default_amount') }}" step="0.01" min="0" placeholder="0.00"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" required>
                    ...
                    <div id="percentage-of-field" class="{{ old('calculation') == 'percentage' ? '' : 'hidden' }}">
                        ...
                        <select name="percentage_of" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent">
                            ...
                            <option value="basic_salary" {{ old('percentage_of') == 'basic_salary' ? 'selected' : '' }}>Basic Salary</option>
                            <option value="gross_salary" {{ old('percentage_of') == 'gross_salary' ? 'selected' : '' }}>Gross Salary</option>
                        </select>

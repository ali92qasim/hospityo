...
@section('title', 'Edit Medicine Brand')

@section('content')
<div class="max-w-3xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800">Edit Medicine Brand</h1>
        <p class="text-gray-600 mt-1">Update brand information</p>
    </div>

    <div class="bg-white rounded-lg shadow-sm p-6">
        <form action="{{ route('medicine-brands.update', $medicineBrand) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-6">
                ...
                <input 
                    ...
                    name="name" 
                    id="name" 
                    value="{{ old('name', $medicineBrand->name) }}"
            ...
            <div class="mb-6">
                ...
                >{{ old('description', $medicineBrand->description) }}</textarea>
                @error('description')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input 
                        ...
                        name="is_active" 
                        value="1"
                        {{ old('is_active', $medicineBrand->is_active) ? 'checked' : '' }}

...
<div class="bg-white rounded-lg shadow p-6">
    <form method="POST" action="{{ route('services.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select id="category" name="category" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" required>
                    ...
                    <option value="lab_test" {{ old('category') == 'lab_test' ? 'selected' : '' }}>Lab Test</option>
            ...
            <div>
                <label for="price" class="block text-sm font-medium text-gray-700 mb-2">Price ({{ currency_symbol() }})</label>
        ...
        <div class="flex justify-end space-x-3 mt-6">
            ...
            <button type="submit" class="bg-medical-blue text-white px-4 py-2 rounded-lg hover:bg-blue-700">Create Service</button>
        </div>
    </form>
</div>

    ...
    <form method="POST" action="{{ route('permissions.store') }}">
        ...
        <div class="mb-6">
            ...
            <input type="text" id="name" name="name" value="{{ old('name') }}" 
                   ...
                   placeholder="e.g., view patients, create appointments" required>
            @error('name')
        ...
        <div class="flex justify-end space-x-3">
            ...
            <button type="submit" class="bg-medical-blue text-white px-4 py-2 rounded-lg hover:bg-blue-700">Create Permission</button>
        </div>
    </form>
</div>
@endsection
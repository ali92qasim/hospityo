    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('visits.index', ['visit_type' => $visit->visit_type]) }}" class="text-gray-600 hover:text-gray-800">
                    <i class="fas fa-arrow-left mr-2"></i>Back to {{ match($visit->visit_type) { 'opd' => 'OPD', 'ipd' => 'Admitted Patients', 'emergency' => 'Emergency', default => 'Visits' } }}
                </a>
            </div>
        </div>
        ...
        <form action="{{ route('visits.update', $visit) }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @php
                        $typeLabels = ['opd' => 'OPD', 'ipd' => 'IPD', 'emergency' => 'Emergency'];
                        $typeBadgeClasses = [
                    ...
                    @endphp
                    <span class="inline-flex px-3 py-2 text-sm font-medium rounded-lg {{ $typeBadgeClasses[$visit->visit_type] ?? 'bg-gray-100 text-gray-800' }}">
                        {{ $typeLabels[$visit->visit_type] ?? ucfirst($visit->visit_type) }}
                    </span>
                </div>
            ...
            <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                <a href="{{ route('visits.index', ['visit_type' => $visit->visit_type]) }}" class="px-6 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50">
                    Cancel
                </a>

...
@section('page-description', 'Update patient information')
    ...
    <div class="bg-white rounded-lg shadow-sm">
        <div class="p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <h3 class="text-lg font-semibold text-gray-800">Edit Patient: {{ $patient->name }}</h3>
        ...
        <form action="{{ route('patients.update', $patient) }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Patient Number</label>
                    <input type="text" value="{{ $patient->patient_no }}" 
                ...
                <div>
                    ...
                    <input type="number" name="age" value="{{ old('age', $patient->age) }}" min="1" max="150"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" 
                           required>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="present_address" rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent">{{ old('present_address', $patient->present_address) }}</textarea>
                </div>

                <div class="md:col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-2">Permanent Address</label>
                    <textarea name="permanent_address" rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent">{{ old('permanent_address', $patient->permanent_address) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="emergency_name" value="{{ old('emergency_name', $patient->emergency_name) }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" 
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="tel" name="emergency_phone" value="{{ old('emergency_phone', $patient->emergency_phone) }}" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent" 
                           required>
                </div>

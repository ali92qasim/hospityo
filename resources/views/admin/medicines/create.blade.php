        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select id="dosage_form" name="dosage_form" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue select2-dosage">
                    ...
                    <option value="gel" {{ old('dosage_form') == 'gel' ? 'selected' : '' }}>Gel</option>
                    ...
                    <option value="solution" {{ old('dosage_form') == 'solution' ? 'selected' : '' }}>Solution</option>
                    <option value="lotion" {{ old('dosage_form') == 'lotion' ? 'selected' : '' }}>Lotion</option>
